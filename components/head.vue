<template>
	<div class="content">
		<div class="top-bar">
			...
			<div class="heade-bar" v-show="false">
				<div class="head">
					<img :src="userinfo.profile.avatarUrl" />
				</div>
				<font>{{userinfo.profile.nickname}}</font>
			</div>
		</div>
		<signup v-show="isSignup" :getUserInfo="getUserInfo"></signup>
	</div>
</template>
		...
		methods: {
			searchInput() { //监听搜索框输入
				...
				get("/api/search/suggest", {
						...
						that.artists = response.data.result.artists;
